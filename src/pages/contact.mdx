...
<div class="flex flex-col justify-center gap-3 md:flex-row">
  <Button href="https://matrix.to/#/#coderdojo:matrix.cyber4edu.org">
    <i class="bi-xl bi-chat"></i> Matrix
  </Button>
  <Button href="mailto:coderdojo_at_cyber4edu.org">
    <i class="bi-xl bi-envelope"></i> E-Mail
  </Button>
</div>
