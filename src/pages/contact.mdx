...
<div class="flex flex-col justify-center md:flex-row gap-3">
  <Button href="https://matrix.to/#/#coderdojo:matrix.cyber4edu.org"><i class="ph-xl ph-chat"></i> Matrix</Button>
  <Button href="mailto:coderdojo_at_cyber4edu.org"><i class="ph-xl ph-envelope"></i> E-Mail</Button>
</div>
