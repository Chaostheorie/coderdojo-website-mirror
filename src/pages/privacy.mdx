...
Verantwortlicher gemäß Art. 4 Abs. 7 EU-Datenschutz-Grundverordnung (DS-GVO) sind Joshua Kobschätzki, Raabestraße 8, 10405 Berlin, joshua `punk` kobschaetzki `@` cobalt.rocks.
